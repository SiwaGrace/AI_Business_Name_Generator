...
const features = [
  {
    ...
    wide: true,
    gradient: "from-violet-600/20 via-nomina-accent/10 to-transparent",
  ...
  return (
    <section className="max-w-4xl mx-auto w-full pb-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        ...
        <div
          className={`lg:col-span-2 relative overflow-hidden bg-nomina-card border border-white/8 rounded-2xl p-6 hover:border-nomina-accent/30 transition-all duration-300 group`}
        >
          <div
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-nomina-muted leading-relaxed">
        ...
        {/* Domain Sync */}
        <div className="relative overflow-hidden bg-nomina-card border border-white/8 rounded-2xl p-6 hover:border-sky-400/30 transition-all duration-300 group text-center flex flex-col items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-xs text-nomina-muted leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Brand Kits */}
        <div className="relative overflow-hidden bg-nomina-card border border-white/8 rounded-2xl p-6 hover:border-fuchsia-400/30 transition-all duration-300 group flex items-center gap-5">
        ...
        {/* CTA */}
        <div className="relative overflow-hidden bg-linear-to-br from-nomina-accent/20 to-violet-600/20 border border-nomina-accent/20 rounded-2xl p-6 flex flex-col justify-between hover:border-nomina-accent/50 transition-all duration-300 group">
          <div>
            <h3 className="text-lg font-black text-white mb-1">
              Join 10k+ Creators
            </h3>
            <p className="text-xs text-nomina-muted">
              Ready to define your space in the market?
            </p>
          </div>
          <button className="mt-4 self-start flex items-center gap-2 px-5 py-2.5 bg-white text-nomina-dark rounded-xl text-sm font-bold hover:bg-nomina-accent hover:text-white transition-all group-hover:shadow-lg">
            Get Started
            <ArrowRight
              size={14}
